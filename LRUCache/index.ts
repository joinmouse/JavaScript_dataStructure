...
lRUCache.put(1, 1); // 缓存是 1
lRUCache.put(2, 2); // 缓存是 1-2
lRUCache.toString();
lRUCache.get(1); // 返回 1, 缓存是 2-1
lRUCache.put(3, 3); // 该操作会使得关键字 2 作废，缓存是 1-3
lRUCache.toString();
lRUCache.get(2); // 返回 -1 (未找到)
lRUCache.put(4, 4); // 该操作会使得关键字 1 作废，缓存是 3-4
lRUCache.toString();
lRUCache.get(1); // 返回 -1 (未找到)
lRUCache.get(3); // 返回 3，缓存 4-3
lRUCache.get(4); // 返回 4， 缓存 3-4
